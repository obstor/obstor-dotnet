...
/// <summary>
/// Convenience extension methods for <see cref="IObstorClient"/> that provide simplified
/// overloads for common operations.
/// </summary>
public static class ObstorClientExtensions
{
    /// <summary>
    ...
    /// </summary>
    /// <param name="client">The <see cref="IObstorClient"/> instance to act on.</param>
    ...
    public static Task RemoveAllBucketNotificationsAsync(this IObstorClient client, string bucketName, CancellationToken cancellationToken = default)
    {
    ...
    /// <see cref="IObstorClient.SetBucketTaggingAsync"/> with a <see langword="null"/> tag collection.
    /// </summary>
    /// <param name="client">The <see cref="IObstorClient"/> instance to act on.</param>
    ...
    public static Task DeleteBucketTaggingAsync(this IObstorClient client, string bucketName, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(client);
    ...
    /// <see cref="IObstorClient.SetObjectLockConfigurationAsync"/> with a <see langword="null"/> retention rule.
    /// </summary>
    /// <param name="client">The <see cref="IObstorClient"/> instance to act on.</param>
    ...
    public static Task RemoveObjectLockConfigurationAsync(this IObstorClient client, string bucketName, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(client);
    ...
    /// <see cref="IObstorClient.ListenBucketNotificationsAsync(string, IEnumerable{EventType}, string, string, CancellationToken)"/>
    ...
    /// </returns>
    public static Task<IObservable<NotificationEvent>> ListenBucketNotificationsAsync(this IObstorClient client, string bucketName, EventType eventType, string prefix = "", string suffix = "", CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(client);

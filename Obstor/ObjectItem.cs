...
public class ObjectItem
{
    ...
    // is requested during listing (Obstor specific feature)

    /// <summary>
    /// Gets the content type of the object. Only populated when metadata is requested
    /// during listing (Obstor-specific feature).
    /// </summary>
    ...
    /// requested during listing (Obstor-specific feature).
    /// </summary>
    public DateTimeOffset? Expires { get; init; }

    /// <summary>
    /// Gets the user-defined metadata associated with the object. Only populated when
    /// metadata is requested during listing (Obstor-specific feature).
    /// </summary>

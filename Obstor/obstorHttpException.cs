...
/// <summary>
/// Exception thrown when a Obstor or S3-compatible server returns an unsuccessful HTTP response.
...
/// </summary>
public class ObstorHttpException : ObstorException
{
    /// <summary>
    ...
    internal ObstorHttpException(HttpRequestMessage request, HttpResponseMessage response, ErrorResponse? error)

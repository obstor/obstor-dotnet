...
/// <summary>
/// Defines the main interface for interacting with a Obstor or S3-compatible object storage service.
/// Covers bucket management, object operations, notifications, object locking, and versioning.
/// </summary>
public interface IObstorClient
{
    // Bucket operations
    ...
    /// the Obstor listen-bucket-notifications endpoint, returning an observable event stream.
    /// </summary>

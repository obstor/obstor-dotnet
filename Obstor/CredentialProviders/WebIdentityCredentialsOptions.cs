...
public class WebIdentityCredentialsOptions
{
    ...
    /// <c>AssumeRoleWithWebIdentity</c> action (e.g. <c>https://obstor.example.com</c> or
    ...
    /// Required when calling AWS STS; optional for Obstor, which may use a default role.
    /// </summary>
    public string RoleARN { get; set; }

    /// <summary>
    /// Gets or sets an optional token revocation type hint passed to the STS endpoint.
    /// Used in certain Obstor or custom STS configurations to indicate how token revocation

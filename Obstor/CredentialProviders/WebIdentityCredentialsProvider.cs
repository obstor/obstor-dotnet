...
/// <summary>
/// An <see cref="ICredentialsProvider"/> implementation that obtains temporary AWS/Obstor credentials
...
public class WebIdentityProvider : ICredentialsProvider
{
    ...
    /// The named client specified by <see cref="WebIdentityCredentialsOptions.ObstorHttpClient"/> is used.
    /// </param>
    ...
    /// </exception>
    /// <exception cref="ObstorHttpException">
    ...
    public async ValueTask<Credentials> GetCredentialsAsync(CancellationToken cancellationToken)
    {
        ...
        if (!resp.IsSuccessStatusCode)
        {
            ...
            if (xRoot == null) throw new ObstorHttpException(req, resp, null);
